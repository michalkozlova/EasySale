...
public class MyRequest extends Request<JSONObject> {
    ...
    public MyRequest(int method, String url, Map<String, String> mHeaders, JSONObject mBody,
                     Response.Listener<JSONObject> mResponseListener, @Nullable Response.ErrorListener errorListener) {
